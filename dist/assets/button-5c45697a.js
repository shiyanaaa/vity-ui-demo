...
</div>`}typeof C=="function"&&C(q);const I={class:"demo"},O=l("h1",null,"Button 按钮",-1),P=l("p",null,"常用的操作按钮。",-1),A=_({__name:"button",setup(u){const r=b([]);return M(async()=>{const s=await Object.assign({"../preview/button/button1.preview.vue":x,"../preview/button/button2.preview.vue":$,"../preview/button/button3.preview.vue":F,"../preview/button/button4.preview.vue":z,"../preview/button/button5.preview.vue":T,"../preview/button/button6.preview.vue":L,"../preview/button/button7.preview.vue":q});for(const y in s){const t=y,n=s[y];r.value.push({name:t,component:j(n)})}}),(s,y)=>(e(),i("div",I,[O,P,(e(!0),i(o,null,c(r.value,t=>(e(),D(E,{key:t.name,component:t.component},null,8,["component"]))),128))]))}});export{A as default};
